...
def get_default_args():
    ...
    parser.add_argument("--experiment_name", type=str, default="LSA64-10-with_validation_testing",
    ...
    # Data
    # r"C:\Users\msi\Desktop\data\WLASL100_train_25fps.csv
    # r"C:\Users\msi\Desktop\data\LSA64_60fps.csv"
    parser.add_argument("--training_set_path", type=str, default=r"C:\Users\msi\Desktop\data\LSA64_60fps.csv", help="Path to the training dataset CSV file")
    parser.add_argument("--testing_set_path", type=str, default=r"C:\spoter-supplementary-data\data\LSA64_60fps_test.csv", help="Path to the testing dataset CSV file")
    ...
    parser.add_argument("--validation_set_size", type=float,
                        help="Proportion of the training set to be split as validation set, if 'validation_size' is set"
                             " to 'split-from-train'")
    parser.add_argument("--validation_set_path", type=str, default=r"C:\spoter-supplementary-data\data\LSA64_60fps_val.csv", help="Path to the validation dataset CSV file")
